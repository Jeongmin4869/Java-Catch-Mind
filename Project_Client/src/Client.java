...
public class Client extends JFrame {
   ...
   public void init() // 화면 구성
   {
      ...
      bt_garlic = new JRadioButton();
       ...
       garlic = new ImageIcon(getClass().getClassLoader().getResource("garlic.png")); // 캐릭터 (마늘쿵야)
       ...
       // 양파 쿵야 캐릭터
        ...
        onion = new ImageIcon(getClass().getClassLoader().getResource("onion.png")); // 캐릭터 (양파쿵야)
        ...
        mushroom = new ImageIcon(getClass().getClassLoader().getResource("mushroom.png")); // 캐릭터 (버섯쿵야)
